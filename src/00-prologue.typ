#v(2em)
#align(center)[
  #text(size: 14pt, weight: "bold")[< AUDIO_LOG_FRAGMENT_RECOVERED >] \
  #text(size: 9pt)[SOURCE: SECTOR 4 SCRAP-HEAP \/\/ DECRYPTION: PARTIAL]
]
#v(2em)

// Swapped #rect for #block with a left-stroke. This breaks across pages safely!
#block(
  width: 100%, 
  stroke: (left: 2pt + rgb("#333333")), 
  inset: (left: 1.5em)
)[
  #set text(size: 10.5pt, style: "italic")
  #set par(leading: 1.5em)
  
  The sound of heavy hydraulics depressurizing cuts through the howling wind.
  
  At the edge of a massive, shadowed canyon of rusted steel and black glass, the older Tarbit drops to one knee. His hands---wrapped in tape and scarred from hot soldering iron burns---work the release valves on his heavy exo-striders. With a heavy *clank*, the thick mechanical legs detach, dropping into the red dust.
  ...
  "Drop the striders, kid," the veteran says, not looking up as he tightens the strap of the cyberdeck across his chest. "We go the rest of the way on our own joints. They'll slow us down if we have to run." the rookie protests, his hands hovering over the release clamps of his own gear. "It's a kilometer to the inner gates. What if the defense drones are active?"
  ...
  "It was perfect," the veteran continues, his voice dropping, "Right up until the Global Warning. When the networks fractured, the main authentication servers went down. The local system survived, but it defaulted into absolute lockdown. It went Read-Only. Nobody had admin privileges anymore."
  ...
  _n.qad_ (We move). "Stay in my shadow," he whispers.
]

#v(2em)
#align(center)[
  #text(size: 9pt)[< END_OF_FILE \/\/ LOG_TERMINATED >]
]
