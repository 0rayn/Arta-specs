...
- *[kʼ]* (Ejective K): A hard, cracking sound in the back of the throat.
- *[qʼ]* (Ejective Q): A deep, hollow throat pop. Sounds like a heavy breaker switch flipping.
- *[ǀ]* (Dental Click): The "tsk tsk" sound. Sounds exactly like a physical relay ticking.
...
- *[s] / [ʃ]*: High and mid-frequency radio static.
...
#block[
  ...
  #table(
    ...
    align(left)[*NASAL (HUM)*], [m], [], [], [n], [], [ŋ], [], [],
    align(left)[*FRICATIVE (STATIC)*], [], [f], [], [s], [ʃ], [x], [ʁ], [h],
    align(left)[*TRILL (MOTOR)*], [], [], [], [r], [], [], [], [],
    align(left)[*EJECTIVE (RELAY)*], [], [], [], [tʼ], [], [kʼ], [qʼ], [],
    align(left)[*CLICK (SWITCH)*], [], [], [ǀ], [], [], [], [], []
  )
]
...
#block[
  ...
  #table(
    ...
    align(left)[*OPEN (BASE)*], [], [ə (Neutral)], []
  )
]
