...
When the central authentication servers went dark, the sprawling, automated megastructures of the Old World---factories, defense grids, and smart cities---were suddenly cut off from their masters. Without the central command to update permissions, these local systems defaulted to absolute, localized lockdown. They went "Read-Only" by design, protecting the pristine infrastructure from the billions of people left behind in the chaos. The Old World didn't just break; the admins logged off, locked the doors, and left humanity to fight over the scraps.
...
The tweakers and over-clockers. They cannot write the root logic or build the boards, but they can aggressively modify existing things to gain a tactical advantage. They strip out safety protocols and hot-wire systems to push hardware past its original limits.
